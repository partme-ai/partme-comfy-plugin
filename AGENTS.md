...
```bash
node scripts/bump-plugin.mjs comfy-design patch   # 文档/注释/小修复
node scripts/bump-plugin.mjs comfy-design minor   # 新功能
node scripts/bump-plugin.mjs comfy-design major   # 破坏性变更
```
